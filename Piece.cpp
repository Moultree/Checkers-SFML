...
void Piece::setTexture()
{
	...
	{
	case BLACK:
		texture.loadFromFile("resources/black_piece.png");
		break;
	case WHITE:
		texture.loadFromFile("resources/white_piece.png");
		break;
	case BLACK_KING:
		texture.loadFromFile("resources/black_piece_king.png");
		break;
	case WHITE_KING:
		texture.loadFromFile("resources/white_piece_king.png");
		break;
	}
